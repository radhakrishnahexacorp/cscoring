...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - BENCH</name>
   <tag></tag>
   ...
   <locator>new UiSelector().className(&quot;android.widget.TextView&quot;).text(&quot;BENCH&quot;).packageName(&quot;com.hexacorp.scoring&quot;).enabled(true).clickable(false).longClickable(false).checkable(false).checked(false).focusable(false).focused(false).scrollable(false).selected(false).index(0)</locator>
